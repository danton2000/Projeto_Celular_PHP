...
--
-- Host: 127.0.0.1
-- Generation Time: 28-Ago-2019 às 17:13
...
CREATE TABLE `tbcelular` (
  ...
  `preço_cel` decimal(6,2) DEFAULT NULL,
...
INSERT INTO `tbcelular` (`id_cel`, `nome_cel`, `memoria_cel`, `armazenamento_cel`, `preço_cel`, `tela_cel`, `sistema_cel`, `camera_cel`, `fk_id_adm`) VALUES
...
--
-- AUTO_INCREMENT for table `tbcelular`
--
ALTER TABLE `tbcelular`
  MODIFY `id_cel` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=33;
